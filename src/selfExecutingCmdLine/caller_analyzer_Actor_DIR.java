		...
		*/
		...
		{			
			...
			ar[2]=current_file_path.substring(0, current_file_path.indexOf(".dl")).concat("_output.txt");
                        //System.out.println(current_file_path.substring(0, current_file_path.indexOf(".dl")).concat("_output.txt"));
			for(int i=1;i<dp.method_count();i++)
			{
                ...
                //LineRetrive lr=new LineRetrive(dl_file_name_arr);
                //lr.lineAnalysis();
                //System.out.println(dl_file_name_arr[0].toString());
